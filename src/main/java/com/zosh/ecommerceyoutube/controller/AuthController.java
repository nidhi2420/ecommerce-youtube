...
import com.zosh.ecommerceyoutube.service.CustomUserServiceImplementation;
...
public class AuthController {
	...
	public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user)throws UserException{
		...
		if(isEmailExist!= null) {
			throw new  UserException("user already used with another account");
		}
	    ...
	    authResponse.setMessage("successfully created");
