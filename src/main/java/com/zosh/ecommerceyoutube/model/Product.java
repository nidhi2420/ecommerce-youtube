...
public class Product {
	 ...
	 * false; Product other = (Product) obj; return Objects.equals(brand,
	 * other.brand) && Objects.equals(category, other.category) &&
	 * Objects.equals(color, other.color) && Objects.equals(description,
	 * other.description) && discountPersent == other.discountPersent &&
	 * discountedPrice == other.discountedPrice && Objects.equals(id, other.id) &&
	 * Objects.equals(imageUrl, other.imageUrl) && numRatings == other.numRatings &&
